...
app.controller('linkCtrl', function($scope) {
	...
	$scope.loadData = function() {
	    ...
	    $scope.otherLinks = [
			{name:'CNSM Récital imaginaire',url:'https://www.conservatoiredeparis.fr/fr/recherche-et-editions/editions-et-publications/recitals-imaginaires/nicolas-dross'},
