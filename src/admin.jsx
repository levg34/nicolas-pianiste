...
function MessageInfo(props) {
    ...
    return <div style={{ color: stringToColour(ip) }}>{`${name} <${email}>`}</div>
}
...
function ConcertInfo(props) {
    ...
    const concertTypes = ['Solo', 'Duo éphémère', 'Trio éphémère', 'Musique vocale et spectacles', 'Composition']
    ...
    return (
        <Container>
            ...
            >
                ...
                <br />
                {concert.details && concert.details.artists && concert.details.artists.length > 0 && (
                    <Card body>
                ...
                {concert.details && concert.details.pieces && concert.details.pieces.length > 0 && (
    ...
    return (
        <Container>
            <Form.Label className="text-danger">
                ...
                <br />
                Le concert <strong>{concert.name}</strong> et ses <strong>{occurrences.length}</strong> occurences
                seront perdues.
            </Form.Label>
            <br />
        ...
        <Container>
            ...
            >
                {occurrences.map((occ, index) => (
                    <div key={occ._id ? occ._id : 'key_' + index} className={occ.deleted ? 'bg-secondary' : undefined}>
                    ...
                    .map((carouselElement) => (
                        <Form.Group key={carouselElement._id}>
                            <Row>
                                <Col>
                                    <Form.Control
                                        placeholder={carouselElement.title !== undefined ? 'Titre' : 'Image principale'}
                                    ...
                                    <Row>
                                        <Col sm>
                                            ...
                                            !(carouselElement._id && carouselElement._id.startsWith('new')) ? (
                                                !carouselElement.deleted ? (
                                                    ...
                                                    <Alert className="mt-2" variant="warning">
                                                        <strong>Attention !</strong> cet élément sera supprimé après
                                                        validation.{' '}
                                                        <Alert.Link
                                                            onClick={(e) => {
                                                                setData({
                                        ...
                                        <Col>
                                            {!carouselElement.active && (
                                                <Form.Control
                                                    ...
                                                    type="number"
                                                    value={
                                                        carouselElement.index !== undefined ? carouselElement.index : 0
                                                    }
                                                    onChange={(e) => {
                                                        setData({
                                                            ...data,
                                ...
                                <Col>
                                    <Form.Control
                                        as="textarea"
                                        rows={3}
                                        placeholder={carouselElement.description !== undefined ? 'Description' : ''}
...
function SelectImageModal(props) {
    ...
    return (
        <Modal size="lg" show={show} onHide={handleClose}>
            ...
            <Modal.Body>
                <Images feedback={feedback} selectImage={setImage} imageType={imageType} />
            </Modal.Body>
            <Modal.Footer>
                ...
                {linkTypes.map((type) => (
                    <Form.Group key={type[0]}>
                        ...
                        {Object.values(links)
                            ...
                            .map((link) => (
                                <Row
                                    className={!link.name && !link._id.startsWith('new') ? 'bg-secondary' : undefined}
                                    key={link._id}
                                >
                                    <Col xs={4}>
            ...
            >
                {[...titles].map((title, titi) => (
                    <Card key={'title-' + titi} body>
                        ...
                        />
                        {[...new Set(repertory.filter((rep) => rep.title === title).map((e) => e.subtitle))].map(
                            (subtitle, tits) => (
                                    ...
                                    {repertory
                                        ...
                                        <Form.Control
                                            ...
                                            onChange={(e) => {
                                                const repCopy = [...repertory]
                                                repertory
                                                    .filter((rep) => rep.title === title && rep.subtitle === subtitle)
                                                    .forEach((rep) => {
            ...
            <Form.Group>
                ...
                {!video.img && (
                    <div>
                        ...
                        {notFound && <Alert variant="warning">Impossible de remplir automatiquement.</Alert>}
                    </div>
                )}
            </Form.Group>
            <Form.Group>
            ...
            <Form.Group controlId="bgColor">
                ...
                <div>
                    {page.bgColor ? (
                        ...
                        <Button variant="outline-secondary" onClick={() => setPage({ ...page, bgColor: '#d3d3d3' })}>
            ...
            {data &&
                data.map((item, index) => (
                    <div key={index}>
                            ...
                            <div key={key}>
                                {key === 'video' ? (
                                    ...
                                    <div>
                                            ...
                                            <div key={subindex}>
                                                <Form.Group controlId={'text' + index + '-' + subindex}>
                                                    ...
                                                    <Form.Control
                                                        ...
                                                        value={paragraph}
                                                        onChange={(e) => setParagraph(index, subindex, e.target.value)}
                                                    />
                                                </Form.Group>
                                                <Button
                                        ...
                                        <Button variant="outline-info" onClick={(e) => addParagraph(index)}>
                                            Ajouter un paragraphe
                                        </Button>
                                    </div>
                                ) : key === 'markdown' ? (
                                    <div>
                                        <Form.Group controlId={'markdown' + index}>
                                            ...
                                            <Form.Control
                                                ...
                                                rows={3}
                                                value={item[key]}
                                                onChange={(e) => setDataItem(index, { ...item, [key]: e.target.value })}
                                            />
                                        </Form.Group>
                                    </div>
                                ) : (
                        ...
                        <ButtonGroup>
                            <Button variant="outline-danger" onClick={(e) => removeDataItem(index)}>
                                Supprimer
                            </Button>
                            {index > 0 && (
                                <Button variant="outline-secondary" onClick={(e) => moveDataItem(index, -1)}>
                                    Monter
                                </Button>
                            )}
                            {index < data.length - 1 && (
        ...
        <Container>
            ...
            >
                {pages.map((page, index) => (
                    <PageFormGroup key={page._id ? page._id : index} page={page} setPage={setPage.bind(null, index)} />
                ))}
                <Button
                    className="mt-2"
                    variant="outline-info"
...
function Content(props) {
    ...
    switch (activePage) {
        ...
        default:
            component = (
                <Container>
                    <Alert variant="danger">{`Component "${activePage}" not found.`}</Alert>
                </Container>
            )
            break
    }
        ...
        <Container fluid>
            ...
            <Container>
                ...
                >
                    ...
                    <Toast.Body>
                        <p>
                            Le token de session ne sera plus valide dans <strong>{Math.floor(toastData.expMin)}</strong>{' '}
                            minutes.
                        </p>
                        <p>
                            Pensez à bien sauvegarder votre travail, ou vous déconnecter et vous reconnecter avant de
                            continuer.
                        </p>
                    </Toast.Body>
                </Toast>
